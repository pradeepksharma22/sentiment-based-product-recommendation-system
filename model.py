...
class SentimentRecommenderModel:
    ...
    RECOMMENDER = "pickle/user_final_rating.pkl"
    VECTORIZER = "pickle/tfidf-vectorizer.pkl"
    CLEANED_DATA = "pickle/cleaned-data.pkl"
    MODEL_NAME = "pickle/sentiment-classification-xg-boost-model.pkl"

    def __init__(self):
        
        self.user_final_rating = pickle.load(open(SentimentRecommenderModel.RECOMMENDER, 'rb'))
        self.vectorizer = pd.read_pickle(SentimentRecommenderModel.VECTORIZER)
        self.cleaned_data = pickle.load(open(SentimentRecommenderModel.CLEANED_DATA, 'rb'))
        self.model = pickle.load(open(SentimentRecommenderModel.MODEL_NAME, 'rb'))
